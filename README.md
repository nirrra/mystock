...
`watchlist_YYYY-MM-DD.csv` 和盘中 `intraday_top20_YYYY-MM-DD.csv` 的前置列按人工查看顺序排列：交易日期、股票代码、名称、涨幅、来源、pattern 命中情况、P1/P2/P4、P4五日均/std、P8、P5、ATR%、建议总仓位、技术指标、Phase 细节、pattern 细节。日常快速浏览优先看前 15-20 列即可。
